              ...
              <div className="">
                ...
                <div className="w-full mt-3 flex justify-between items-center md:grid md:grid-cols-3 md:justify-between md:gap-8">
                  ...
                  <div className="relative flex-1">
                    <div className="absolute aspect-video overflow-hidden w-full top-1/2 -translate-y-1/2 opacity-0 scale-90 group-hover/project:opacity-100 group-hover/project:scale-100 lg:group-hover/project:scale-110 transition-all duration-500 z-10">
                      <img alt={project.title} src={project.imageUrl} />
                    </div>
                  </div>
